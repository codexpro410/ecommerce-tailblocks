...
export const Product = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto max-h-[500px] h-64 object-contain object-center rounded"
       src={product.image}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex justify-between items-center mt-10">
          <span className="title-font font-medium text-2xl text-gray-900">${product.price}</span>
            ...
            <button className="flex mr-1 ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none
                    hover:bg-purple-600 rounded"  onClick={()=>handleCart(product,true)}>Buy Now</button>
                    <button className="flex ml-auto border py-2 px-6 focus:outline-none
                    hover:bg-purple-600 hover:text-white rounded" onClick={()=>handleCart(product)}>Add to cart</button>
            </div>
          <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center
           text-gray-500 ml-4">
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
